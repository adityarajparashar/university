...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    JButton cancel,submit;
        ...
        tfsub5.setBounds(50,200,200,20);
        add(tfsub5);
        
        tfmarks1=new JTextField();
        tfmarks1.setBounds(260,230,200,20);
        add(tfmarks1);
        
        tfmarks2=new JTextField();
        tfmarks2.setBounds(260,260,200,20);
        add(tfmarks2);
        
        tfmarks3=new JTextField();
        tfmarks3.setBounds(260,290,200,20);
        add(tfmarks3);
        
        tfmarks4=new JTextField();
        tfmarks4.setBounds(260,320,200,20);
        add(tfmarks4);
        
        tfmarks5=new JTextField();
        tfmarks5.setBounds(260,200,200,20);
        add(tfmarks5);
